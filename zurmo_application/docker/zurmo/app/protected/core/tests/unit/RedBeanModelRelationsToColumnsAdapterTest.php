<?php
    ...
    class RedBeanModelRelationsToColumnsAdapterTest extends BaseTest
    {
        ...
        {
            $modelClassName     = null;
            $relations          = array('person' => array(RedBeanModel::HAS_ONE, 'Person'));
            $columns            = RedBeanModelRelationsToColumnsAdapter::resolve($modelClassName,
                                                                                $relations,
         ...
         */
        public function testResolveWithEmptyRelations()
        {
            $modelClassName     = 'User';
            $relations          = array();
            $columns            = RedBeanModelRelationsToColumnsAdapter::resolve($modelClassName,
