<?php
    ...
    class AccountAccountAffiliationsModule extends SecurableModule
    {
        const RIGHT_ACCESS_ACCOUNT_ACCOUNT_AFFILIATIONS = 'Access AccountAccountAffiliations Tab';
        ...
        public static function getTranslatedRightsLabels()
        {
            ...
            $labels                                                  = array();
            $labels[self::RIGHT_ACCESS_ACCOUNT_ACCOUNT_AFFILIATIONS] = Zurmo::t('MarketingModule',
                            'Access AccountsModuleSingularLabel to AccountsModuleSingularLabel  Affiliations Tab', $params);
            return $labels;
        }
        ...
        {
            return self::RIGHT_ACCESS_ACCOUNT_ACCOUNT_AFFILIATIONS;
        }
