        ...
        public static function getDefaultMetadata()
        {
            ...
            $metadata[__CLASS__] = array(
                ...
                'relations' => array(
                    ...
                    'hasOne'              => array(static::HAS_ONE,   'WorkflowModelTestItem2', static::NOT_OWNED,
                                                static::LINK_TYPE_SPECIFIC, 'hasOne'),
                    'hasOneAgain'         => array(static::HAS_ONE,   'WorkflowModelTestItem2', static::NOT_OWNED,
                                                static::LINK_TYPE_SPECIFIC, 'hasOneAgain'),
                    'hasMany'             => array(static::HAS_MANY,  'WorkflowModelTestItem3', static::NOT_OWNED,
                                                static::LINK_TYPE_SPECIFIC, 'hasMany'),
                    'hasOneAlso'          => array(static::HAS_ONE,   'WorkflowModelTestItem4', static::NOT_OWNED,
                    ...
                    'cannotTrigger2'      => array(static::MANY_MANY, 'WorkflowModelTestItem5'),
                    'usedAsAttribute' => array(static::HAS_ONE, 'WorkflowModelTestItem6', static::NOT_OWNED),
                ...
                'derivedRelationsViaCastedUpModel' => array(
                    'model5ViaItem' => array(static::MANY_MANY, 'WorkflowModelTestItem5', 'workflowItems')
                ),
                'rules' => array(
                    ...
                    array('cannotTrigger',    'length',  'min'  => 1, 'max' => 64),
