<?php
    ...
    /**
     * The portlet view for game rewards detail view
     */
    class GameRewardDetailsPortletView extends GameRewardEditAndDetailsView implements PortletViewInterface
    {
        protected $params;
        protected $viewData;
        ...
        {
            return 'GameRewardEditAndDetailsView';
        }
