<?php
     ...
     * Racing collection
     */
    class RacingGameCollectionRules extends GameCollectionRules
    {
        /**
         * @return string
         */
        ...
        {
            return Zurmo::t('GamificationModule', 'Racing');
        }
        ...
        {
            return Zurmo::t('GamificationModule', 'Flags');
        }
    }
?>