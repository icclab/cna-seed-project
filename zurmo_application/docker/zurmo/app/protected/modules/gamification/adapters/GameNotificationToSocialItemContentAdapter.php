<?php
    ...
    /**
     * Adapter to take a GameNotification object and render content for a social item.
     */
    class GameNotificationToSocialItemContentAdapter extends GameNotificationToContentAdapter
    {
        /**
