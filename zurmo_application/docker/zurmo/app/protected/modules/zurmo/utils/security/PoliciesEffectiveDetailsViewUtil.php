<?php
     ...
     */
    class PoliciesEffectiveDetailsViewUtil extends SecurityViewUtil
    {
        /**
        ...
        {
            $rules = PolicyRulesFactory::createPolicyRulesByModuleClassNameAndPolicyInformation(
                        $moduleClassName,
                        $policy,
            ...
            {
                $policy        = $policy . FormModelUtil::DELIMITER . 'effective';
            ...
            $element = array(
                ...
                'type'          => $rules->getEffectiveElementAttributeType(),
            );
            return $element;
        }
    }
