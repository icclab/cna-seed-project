<?php
    ...
    /**
     * Display the group selection.  This is specifically
     * for selecting a parent group.
     */
    class ParentGroupElement extends GroupElement
    {
        protected function renderControlEditable()
        {
            assert('$this->model instanceof Group');
        ...
        {
            return Zurmo::t('ZurmoModule', 'Select a Parent Group');
        }
    }
?>
