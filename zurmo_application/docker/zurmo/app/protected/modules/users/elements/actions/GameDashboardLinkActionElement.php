<?php
    ...
    class GameDashboardLinkActionElement extends ModalListLinkActionElement
    {
        ...
        public function render()
        {
            ...
            $content .= $ajaxLink = ZurmoHtml::ajaxLink($label, $this->getDefaultRoute(),
                                                        HeaderLinksView::resolveAjaxOptionsForGameDashboardModel($id),
                                                        $this->getHtmlOptions());
        ...
        {
            return Yii::app()->createUrl('users/default/gameDashboard/', array('id' => $this->modelId));
        }

        protected function getDefaultLabel()
        {
            return Zurmo::t('GamificationModule', 'Game Dashboard');
        }
