<?php
    ...
    return array(
        ...
        'ContactsModuleSingularLabel or LeadsModuleSingularLabel ID'
            => 'ContactsModuleSingularLabel ID oder LeadsModuleSingularLabel',
        'ContactsModuleSingularLabel or LeadsModuleSingularLabel Name'
            => 'ContactsModuleSingularLabel oder LeadsModuleSingularLabel Name',
        ...
        'Create LeadsModulePluralLabel'
            => 'LeadsModulePluralLabel erstellen',
        'Create LeadsModuleSingularLabel'
            => 'LeadsModuleSingularLabel erstellen',
        'Delete LeadsModulePluralLabel'
            => 'LeadsModulePluralLabel löschen',
        'Do not show AccountsModuleSingularLabel'
            => 'AccountsModuleSingularLabel Nicht anzeigen',
        'Lead'
            => 'Interessent',
        'Leads'
            => 'Interessenten',
        ...
        'LeadsModuleSingularLabel ID'
            => 'LeadsModuleSingularLabel ID', // Same Word Translated
        ...
        'LeadsModuleSingularLabel was not converted. An error occurred.'
            => 'LeadsModuleSingularLabel wurde nicht konvertiert. Ein Fehler ist aufgetreten',
        'My LeadsModulePluralLabel'
            => 'Meine LeadsModulePluralLabel',
        'Select AccountsModuleSingularLabel'
            => 'AccountsModuleSingularLabel Wählen',
        'Skip AccountsModuleSingularLabel'
            => 'AccountsModuleSingularLabel überspringen',
        '{n} LeadsModuleSingularLabel created|{n} LeadsModulePluralLabel created'
            => '{n} LeadsModuleSingularLabel erstellt|{n} LeadsModulePluralLabel erstellt',
    );
?>
