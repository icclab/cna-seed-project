<?php
    ...
    class GameRewardEditAndDetailsView extends SecuredEditAndDetailsView
    {
                ...
                'global' => array(
                    'toolbar' => array(
                        'elements' => array(
                            ...
                            array('type' => 'GameRewardDeleteLink', 'renderType' => 'Details'),
                        ),
                    ),
                            ...
                            'rows' => array(
                                ...
                                array('cells' =>
                                    array(
                                        array(
                                            'elements' => array(
                                                array('attributeName' => 'cost', 'type' => 'Integer'),
                                            ),
                                        ),
                                    )
                                ),
                                ...
                                array('cells' =>
                                    array(
                                        array(
                                            'elements' => array(
                                                array('attributeName' => 'expirationDateTime', 'type' => 'DateTime'),
                                            ),
                                        ),
                                    )
                                ),
