    ...
    class MultiSelectDropDownSanitizerUtil extends DropDownSanitizerUtil
    {
                ...
                else
                {
                    ...
                    if ($generateMissingPickListError)
                    {
                        throw new InvalidValueToSanitizeException(Zurmo::t('ImportModule', 'Pick list value specified ' .
                            'is missing from existing pick list and no valid instructions ' .
                                                                                   ...
                                                                                   array $lowerCaseDropDownValues)
        {
            ...
            if (isset($lowerCaseMissingValuesToMap[mb_strtolower($aValue)]))
            {
                ...
                if ($keyToUse === false)
                {
                    throw new InvalidValueToSanitizeException(Zurmo::t('ImportModule', 'Pick list value specified is ' .
                            'missing from existing pick list, has a specified mapping value, ' .
