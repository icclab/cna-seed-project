<?php
    ...
    /**
     * Display the opportunity selection. This is a
     * combination of a type-ahead input text field
     * and a selection button which renders a modal list view
     * to search on opportunity.  Also includes a hidden input for the user
     * id.
     */
    class OpportunityElement extends ModelElement
    {
        protected static $moduleId = 'opportunities';
