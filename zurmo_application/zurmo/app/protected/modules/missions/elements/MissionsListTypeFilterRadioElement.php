<?php
    ...
    /**
     * Element for displaying available types to filter a list of missions on.
     */
    class MissionsListTypeFilterRadioElement extends Element
    {
        /**
        ...
        {
            assert('$this->model instanceof MissionsListConfigurationForm');
        ...
        {
            $data = array();
            foreach ($this->model->getTypesAndLabels() as $type => $label)
            {
                $data[$type] = $label;
            }
            return $data;
