<?php
     ...
     */
    class CreateReportGameBadgeRules extends GameBadgeRules
    {
        ...
        {
            return Zurmo::t('ReportsModule', '{n} Report created|{n} Reports created',
                            array($value));
        }
        ...
        public static function badgeGradeUserShouldHaveByPointsAndScores($userPointsByType, $userScoresByType)
        {
            ...
            if (isset($userScoresByType['CreateSavedReport']))
            {
                return static::getBadgeGradeByValue((int)$userScoresByType['CreateSavedReport']->value);
            }
            return 0;
        }
    }
