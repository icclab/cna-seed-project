<?php
     ...
     * Golf collection
     */
    class GolfGameCollectionRules extends GameCollectionRules
    {
        /**
         * @return string
         */
        ...
        {
            return Zurmo::t('GamificationModule', 'Golf');
        }
        ...
        {
            return array(   'GolfBall' => Zurmo::t('GamificationModule', 'Golf Ball'),
                            'GolfBag'          => Zurmo::t('GamificationModule', 'Golf Bag'),
                            'GolfCart'          => Zurmo::t('GamificationModule', 'Golf Cart'),
                            'GolfShoe'      => Zurmo::t('GamificationModule', 'Golf Shoe'),
                            'GolfBat'            => Zurmo::t('GamificationModule', 'Golf Bat'),
            );
        }
        ...
        {
            return Zurmo::t('GamificationModule', 'Green');
        }
    }
?>