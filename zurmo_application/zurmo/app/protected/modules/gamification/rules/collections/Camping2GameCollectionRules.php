<?php
     ...
     * Camping2 collection
     */
    class Camping2GameCollectionRules extends GameCollectionRules
    {
        /**
         * @return string
         */
        ...
        {
            return Zurmo::t('GamificationModule', 'Camping');
        }
        ...
        {
            return array(   'Binoculars' => Zurmo::t('GamificationModule', 'Binoculars'),
                            'Shovel'          => Zurmo::t('GamificationModule', 'Shovel'),
                            'Compass'          => Zurmo::t('GamificationModule', 'Compass'),
                            'Signs'      => Zurmo::t('GamificationModule', 'Signs'),
                            'SUV'            => Zurmo::t('GamificationModule', 'SUV'),
            );
        }
        ...
        {
            return Zurmo::t('GamificationModule', 'Bon Fire');
        }
    }
?>