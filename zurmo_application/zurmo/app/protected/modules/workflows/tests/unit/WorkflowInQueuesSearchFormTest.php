<?php
    ...
    class WorkflowInQueuesSearchFormTest extends BaseTest
    {
        ...
        public function testGetInQueueSearchableModelNamesAndLabels()
        {
            ...
            $this->assertTrue(isset($data['Account']));
            $this->assertTrue(isset($data['Contact']));
            $this->assertTrue(isset($data['Meeting']));
            $this->assertTrue(isset($data['Opportunity']));
            $this->assertTrue(isset($data['Product']));
            $this->assertTrue(isset($data['Task']));
            $this->assertTrue(isset($data['SavedWorkflow']));
        }
    }
?>