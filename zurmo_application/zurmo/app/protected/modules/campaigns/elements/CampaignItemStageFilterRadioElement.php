<?php
    ...
    /**
     * Element for displaying a stage filter for campaign item portlet view.  You can either
     * view campaign items in all or 'opened' or 'clicked' or 'bounced' stage.
     */
    class CampaignItemStageFilterRadioElement extends Element
    {
        /**
        ...
        {
            assert('$this->model instanceof CampaignItemsConfigurationForm');
