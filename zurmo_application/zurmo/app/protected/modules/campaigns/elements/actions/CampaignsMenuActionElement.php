<?php
    ...
    /**
     * Link element to take you to a list of campaign models
     */
    class CampaignsMenuActionElement extends MenuActionElement
    {
        /**
         * @return string
         */
        ...
        {
            return Yii::app()->createUrl('campaigns/default/list/');
        }
