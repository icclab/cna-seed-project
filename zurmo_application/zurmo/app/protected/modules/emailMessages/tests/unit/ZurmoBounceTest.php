<?php
    ...
    class ZurmoBounceTest extends ZurmoBaseTest
    {
        ...
        public function testInit()
        {
            ...
            $form->imapPort             = '420';
            $form->imapUsername         = 'bouncy';
            $form->imapPassword         = 'bounces';
            $form->imapFolder           = 'BOUNCES';
            $form->returnPath           = 'bounce@bounce.com';
            $form->imapSSL              = 1;
            ...
            $this->assertEquals('bounce@bounce.com',    $bounce->returnPath);
        }
    }
?>