<?php
    ...
    class MarketingListsForContactRelatedListView extends MarketingListsRelatedListView
    {
        /**
        ...
        public static function getDefaultMetadata()
        {
            ...
            $metadata['global']['toolbar']['elements'][] =
                array('type'                 => 'SelectMarketingListForContactFromRelatedListAjaxLink',
        ...
        {
            return Zurmo::t('MarketingListsModule', 'Marketing Lists For ContactsModuleSingularLabel/LeadsModuleSingularLabel',
        ...
        /**
         * @see $this->makeSearchAttributeData()
         * @return string
         */
        ...
        protected function makeSearchAttributeData()
        {
            ...
            $searchAttributeData['clauses'] = array(
                1 => array(
                    ...
                    'relatedAttributeName' => $this->getRelationAttributeName(),
                    'operatorType'         => 'equals',
