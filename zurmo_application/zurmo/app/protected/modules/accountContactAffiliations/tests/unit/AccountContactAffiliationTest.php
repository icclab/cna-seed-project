<?php
    ...
    class AccountContactAffiliationTest extends ZurmoBaseTest
    {
        ...
        public function testGetPrimaryByAccountIdAndContactId()
        {
            ...
            $accountContactAffiliations = AccountContactAffiliation::
                                          getPrimaryByAccountIdAndContactId($accountContactAffiliations[0]->account->id,
                                                                            $accountContactAffiliations[0]->contact->id);
