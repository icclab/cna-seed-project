<?php
    ...
    class UsersByModelModalListControllerTest extends ZurmoBaseTest
    {
        ...
        public function testMakeModalSearchAttributeDataByModel()
        {
            ...
            $this->assertEquals(1, count($searchAttributeData['clauses']));
            $this->assertEquals(3, count($searchAttributeData['clauses']['1']));

            $this->assertEquals('role', $searchAttributeData['clauses']['1']['attributeName']);
            $this->assertEquals('equals', $searchAttributeData['clauses']['1']['operatorType']);
            $this->assertEquals(self::$roleId, $searchAttributeData['clauses']['1']['value']);
            $this->assertEquals('1', $searchAttributeData['structure']);
        }
