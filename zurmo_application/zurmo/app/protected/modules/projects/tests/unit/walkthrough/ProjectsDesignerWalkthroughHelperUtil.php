<?php
    ...
    /**
     * Helper functions to assist with testing designer walkthroughs specifically for project layouts.
     */
    class ProjectsDesignerWalkthroughHelperUtil
    {
        public static function getProjectEditAndDetailsViewLayoutWithAllCustomFieldsPlaced()
        {
            return array(
                    'panels' => array(
                        array(
                            ...
                            'rows' => array(
                                ...
                                array('cells' =>
                                    array(
                                        array(
                                            'element' => 'MultipleOpportunitiesForProjects',
                                        ),
                                    )
                                ),
                                array('cells' =>
                                    array(
                                        array(
                                            'element' => 'MultipleContactsForProjects',
                                        ),
                                    )
                                ),
                                array('cells' =>
                                    array(
                                        array(
                                            'element' => 'MultipleAccountsForProjects',
                                        ),
                                    )
                                ),
                                array('cells' =>
        ...
        public static function getProjectsSearchViewLayoutWithAllCustomFieldsPlaced()
        {
            return array(
                    'panels' => array(
                        array(
         ...
         */
        public static function getProjectsListViewLayoutWithAllStandardAndCustomFieldsPlaced()
        {
            return array(
                    'panels' => array(
                        array(
        ...
        /**
         * This function returns the necessary get parameters for the project search form
         * based on the project edited data.
         */
        public static function fetchProjectsSearchFormGetData($superUserId)
        {
            return array(
                            'name'               => 'myEditProject',
