<?php
    ...
    /**
     * Adapt module form data from the designer tool
     * where you edit the module metadata settings into
     * the module metadata.
     */
    class ModuleFormToMetadataAdapter
    {
        protected $module;

        protected $form;

        public function __construct(Module $module, ModuleForm $form)
        {
            $this->module   = $module;
            $this->form     = $form;
        }
