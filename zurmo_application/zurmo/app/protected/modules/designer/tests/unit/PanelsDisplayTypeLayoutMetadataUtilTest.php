<?php
    ...
    class PanelsDisplayTypeLayoutMetadataUtilTest extends ZurmoBaseTest
    {
        ...
        public function testPopulateSaveableMetadataFromPostData()
        {
            ...
            $populated = PanelsDisplayTypeLayoutMetadataUtil::populateSaveableMetadataFromPostData(
                                    $savableMetadata, $postData);
