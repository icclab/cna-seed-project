<?php
    ...
    class DesignerModelToViewUtilTest extends ZurmoBaseTest
    {
        ...
        public function testGetModelAttributesAdapter()
        {
            ...
            $adapter = DesignerModelToViewUtil::getModelAttributesAdapter(
                'AccountEditAndDetailsView',
                'Account'
            );
            $this->assertTrue($adapter instanceof ModelAttributesAdapter);
        }
