<?php
    ...
    /**
     * Link element to take you to a list of email template models that are specific for contact
     */
    class EmailTemplatesForMarketingMenuActionElement extends MenuActionElement
    {
        /**
         * @return string
         */
        ...
        {
            return Yii::app()->createUrl('emailTemplates/default/listForMarketing/');
        }
