<?php
    ...
    /**
     * Helper class for generating a random tip or tips to display.
     */
    class ZurmoTipsUtil
    {
        public static function getSingleRandomTipContent()
        {
            $tips   = require(Yii::getPathOfAlias('application.modules.zurmo.utils.ZurmoTips') . '.php');
