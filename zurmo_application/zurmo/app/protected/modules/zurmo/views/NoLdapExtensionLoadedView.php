<?php
    ...
    /**
     * View  for showing in the user interface to intimate that LDAP Protocol is not enabled.
     * This needs to be enable first before LDAP Authentication can be setup.
     */
