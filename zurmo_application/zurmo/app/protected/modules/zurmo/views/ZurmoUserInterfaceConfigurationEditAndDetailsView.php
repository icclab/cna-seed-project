<?php
    ...
    /**
     * Edit and details view for the zurmo user interface configuration view.
     */
    class ZurmoUserInterfaceConfigurationEditAndDetailsView extends EditAndDetailsView
    {
        public function getTitle()
        {
            return Zurmo::t('ZurmoModule', 'User Interface Configuration');
        }
