<?php
    ...
    /**
     * Adapter class to generate column definition for parent's column when provided with modelClassName
     */
    abstract class RedBeanModelChildParentRelationshipToColumnAdapter
    {
        ...
        protected static function resolveParentThatCanHaveBeen($modelClassName)
        {
            ...
            {
                return static::resolveParentThatCanHaveBeen($parentClassName);
            }
        }
    }
?>