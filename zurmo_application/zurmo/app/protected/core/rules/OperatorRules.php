    ...
    class OperatorRules
    {
        ...
        public static function translatedTypeLabels()
        {
            return array(OperatorRules::TYPE_EQUALS                      => Zurmo::t('Core', 'Equals'),
                         ...
                         OperatorRules::TYPE_DOES_NOT_STARTS_WITH        => Zurmo::t('Core', 'Does Not Start With'),
                         OperatorRules::TYPE_ENDS_WITH                   => Zurmo::t('Core', 'Ends With'),
                         OperatorRules::TYPE_DOES_NOT_ENDS_WITH          => Zurmo::t('Core', 'Does Not End With'),
                         OperatorRules::TYPE_CONTAINS                    => Zurmo::t('Core', 'Contains'),
                         OperatorRules::TYPE_DOES_NOT_CONTAINS           => Zurmo::t('Core', 'Does Not Contain'),
