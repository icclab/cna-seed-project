<?php
    ...
    class MashableInboxRulesTest extends ZurmoBaseTest
    {
        ...
        public function testGetListViewClassName()
        {
            $stub = $this->getNewStub();
            $stub->expects($this->any())
                 ->method('getModelClassName')
                 ->will($this->returnValue('MashableInboxForTestModel'));
            $this->assertEquals('MashableInboxForTestsListView', $stub->getListViewClassName());
        }

        public function testGetZeroModelViewClassName()
        {
            $stub = $this->getNewStub();
            $stub->expects($this->any())
                 ->method('getModelClassName')
