<?php
    ...
    class BuilderElementBackgroundPropertiesEditableElementsUtil extends BuilderElementPropertiesEditableElementsUtil
    {
        protected static function resolveConfiguration()
        {
            ...
            $configurationItems[]       = static::resolveConfigurationItem(
                                            ...
                                            static::resolveDefaultParams(
                                                Zurmo::t('EmailTemplatesModule', 'Background Color')));
