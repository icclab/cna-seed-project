<?php
    ...
    class MinMaxValueAttributeEditView extends MaxLengthAttributeEditView
    {
                            ...
                            'rows' => array(
                                ...
                                array('cells' =>
                                    array(
                                        array(
                                            'elements' => array(
                                                array('attributeName' => 'defaultValue', 'type' => 'Text'),
                                            ),
                                        ),
                                    )
                                ),
                                array('cells' =>
                                    array(
                                        array(
                                            'elements' => array(
                                                array('attributeName' => 'minValue', 'type' => 'Text'),
                                            ),
                                        ),
                                    )
                                ),
                                array('cells' =>
                                    array(
                                        array(
                                            'elements' => array(
                                                array('attributeName' => 'maxValue', 'type' => 'Text'),
                                            ),
                                        ),
                                    )
                                ),
