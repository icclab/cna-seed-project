<?php
    ...
    /**
     * Returns read-only attribute type display
     */
    class AttributeTypeElement extends Element
    {
        /**
        ...
        protected function renderControlNonEditable()
        {
            ...
            return Yii::app()->format->text($modelClassName::getAttributeTypeDisplayName());
        }
