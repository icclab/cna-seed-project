<?php
    ...
    class ContactsZeroModelsYetView extends ZeroModelsYetView
    {
        ...
        {
            return Zurmo::t('ContactsModule', 'Create ContactsModuleSingularLabel', LabelUtil::getTranslationParamsForAllModules());
        }

        protected function getMessageContent()
        {
            return Zurmo::t('ContactsModule', '<h2>"Skill is fine, and genius is splendid, but the right Contacts are more ' .
