<?php
    ...
    /**
     * Display the role selection. This is a
     * combination of a type-ahead input text field
     * and a selection button which renders a modal list view
     * to search on role.  Also includes a hidden input for the role
     * id.
     */
    class RoleElement extends ModelElement
    {
         ...
         * form the Role Editable Element
