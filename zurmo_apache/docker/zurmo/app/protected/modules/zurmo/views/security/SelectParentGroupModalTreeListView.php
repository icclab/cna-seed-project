<?php
     ...
     * groups that is used for selecting a parent
     * group.  Does not allow picking of a group
    ...
    class SelectParentGroupModalTreeListView extends GroupsModalTreeListView
    {
        ...
        /**
         * Only display node as linkable if the groupId does not
         * match the $this->modelId
         */
        protected function resolveIsNodeLinkableById($id, $name)
        {
            if ($name == Group::EVERYONE_GROUP_NAME || $id == $this->modelId)
            {
                return false;
            }
            return true;
