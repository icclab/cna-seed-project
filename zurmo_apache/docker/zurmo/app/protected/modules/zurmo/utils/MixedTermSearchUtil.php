<?php
    ...
    /**
     * Helper class to adapt a mixed term into the appropriate search attributes based on which attributes real or
     * derived are supported for mixed term search by a module.
     */
