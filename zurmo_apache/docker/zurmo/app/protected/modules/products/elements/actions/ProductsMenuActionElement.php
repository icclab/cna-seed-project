<?php
    ...
    /**
     * Link element to take you to a list of product models
     */
    class ProductsMenuActionElement extends MenuActionElement
    {
        /**
         * @return string
         */
        protected function getDefaultLabel()
        {
            ...
            return Zurmo::t('ProductsModule', 'ProductsModulePluralLabel', $params);
        }
