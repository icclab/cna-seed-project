<?php
    ...
    /**
     * Class utilized by activityItems element to process security check on the possible related model elements.
     */
    class ActivityItemsModalListActionSecurity extends RightsOnlyActionSecurity
    {
        /**
