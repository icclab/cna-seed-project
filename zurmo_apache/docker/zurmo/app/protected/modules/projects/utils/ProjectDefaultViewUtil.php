<?php
    ...
    /**
     * Helper class for constructing the project view used
     */
    class ProjectDefaultViewUtil extends ZurmoDefaultViewUtil
    {
        protected static $activeModuleId = 'projects';
        ...
        protected static function resolveForActiveMenuItem(&$items, $controller)
        {
            ...
            foreach ($items as $key => $item)
            {
                ...
                {
                    if ($item['moduleId'] == 'projects' && $controllerModuleId == 'projects')
                    {
