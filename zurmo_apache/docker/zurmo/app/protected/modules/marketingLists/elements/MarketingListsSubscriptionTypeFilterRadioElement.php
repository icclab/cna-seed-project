<?php
    ...
    /**
     * Element for displaying a owned by filter for a marketing lists member view. You can either
     * view all or 'owned' activities.
     */
    class MarketingListsSubscriptionTypeFilterRadioElement extends Element
    {
        /**
        ...
        {
            assert('$this->model instanceof MarketingListMembersConfigurationForm');
