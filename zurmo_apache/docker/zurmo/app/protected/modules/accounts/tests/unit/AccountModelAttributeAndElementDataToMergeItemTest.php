<?php
    ...
    class AccountModelAttributeAndElementDataToMergeItemTest extends ModelAttributeAndElementDataToMergeItemBaseTest
    {
        ...
        public $nonDerivedAttributes = array('name', 'officePhone', 'officeFax', 'employees', 'annualRevenue', 'website', 'description');

        public $dropdownAttributes   = array('industry', 'type');

        public $multiAttributeElements = array('billingAddress' => 'Address', 'shippingAddress' => 'Address');

        public $modelAttributeAndElementDataToMergeItem = 'AccountModelAttributeAndElementDataToMergeItem';
