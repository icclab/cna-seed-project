<?php
    ...
    class CampaignItemActivitiesDemoDataMaker extends EmailMessageActivitiesDemoDataMaker
    {
        ...
        public function makeAll(& $demoDataHelper)
        {
            ...
            assert('$demoDataHelper->isSetRange("CampaignItem")');
            ...
            $this->populateMarketingItems('CampaignItem', $activity->campaignItem->campaign->subject);
        }

        public function populateModel(& $model)
        {
            assert('$model instanceof CampaignItemActivity');
