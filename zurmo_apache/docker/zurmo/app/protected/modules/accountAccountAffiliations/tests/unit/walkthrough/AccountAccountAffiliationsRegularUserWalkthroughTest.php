<?php
     ...
     */
    class AccountAccountAffiliationsRegularUserWalkthroughTest extends ZurmoRegularUserWalkthroughBaseTest
    {
        ...
        public function testRegularUserHasIncorrectRightsAndThenElevates()
        {
            ...
            $this->runControllerShouldResultInAccessFailureAndGetContent('accountAccountAffiliations/default/createFromRelation');

            //Now add rights to AccountAccountAffiliationsModule
            $super = $this->logoutCurrentUserLoginNewUserAndGetByUsername('super');

            //Now test peon with elevated rights
            $nobody = User::getByUsername('nobody');
            $nobody->setRight('AccountAccountAffiliationsModule', AccountAccountAffiliationsModule::RIGHT_ACCESS_ACCOUNT_ACCOUNT_AFFILIATIONS);
            $this->assertTrue($nobody->save());

            //Should still failure because missing access to accounts
            Yii::app()->user->userModel = User::getByUsername('nobody');
            $this->setGetArray(array(   'relationAttributeName' => 'primaryAccount',
                'relationModelId'       => self::$account->id,
                'relationModuleId'      => 'accounts',
            ...
            $this->setGetArray(array(   'relationAttributeName' => 'primaryAccount',
                ...
                'relationModuleId'      => 'accounts',
                'redirectUrl'           => 'someRedirect'));
            $this->runControllerWithNoExceptionsAndGetContent('accountAccountAffiliations/default/createFromRelation');
        }
    }
?>
