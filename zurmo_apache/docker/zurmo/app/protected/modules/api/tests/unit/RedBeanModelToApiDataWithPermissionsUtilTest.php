<?php
    ...
    /**
    * Test RedBeanModelToApiDataWithPermissionsUtil functions.
    */
    class RedBeanModelToApiDataWithPermissionsUtilTest extends ZurmoBaseTest
    {
        ...
        public function testGetDataWithNoRelationsSet()
        {
            ...
            $adapter     = new RedBeanModelToApiDataWithPermissionsUtil($testItem);
