<?php
    ...
    /**
     * Renders an action bar specifically for the opportunities search and listview.
     */
    class OpportunitiesSecuredActionBarForSearchAndListView extends SecuredActionBarForSearchAndListView
    {
