<?php
    ...
    class LeadsMergedEditAndDetailsView extends LeadEditAndDetailsView
    {
        /**
         * Selected leads for merge
         * @var array
         */
         ...
         * @param Array $selectedLeads contacts selected for merge
         */
        public function __construct($renderType, $controllerId, $moduleId, $model, $selectedLeads)
        {
