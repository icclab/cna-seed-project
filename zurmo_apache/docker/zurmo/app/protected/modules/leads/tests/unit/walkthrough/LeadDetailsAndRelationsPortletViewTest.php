<?php
    ...
    class LeadDetailsAndRelationsPortletViewTest extends ZurmoWalkthroughBaseTest
    {
        ...
        public function testAdditionOfPortletsInEmptyRightPanel()
        {
            ...
            $this->setGetArray(array('portletId'               => $portlet->id,
                                     'relationAttributeName'   => 'lead',
                                     'relationModelId'         => $superLeadId,
                                     'relationModuleId'        => 'leads',
