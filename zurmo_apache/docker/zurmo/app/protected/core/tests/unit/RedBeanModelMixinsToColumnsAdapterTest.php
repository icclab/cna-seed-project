<?php
    ...
    class RedBeanModelMixinsToColumnsAdapterTest extends BaseTest
    {
        ...
        {
            $modelClassName = null;
            $columns        = RedBeanModelMixinsToColumnsAdapter::resolve($modelClassName, static::$messageLogger);
