<?php
    ...
    /**
     * Displays a modified date/time stamp localized.
     */
    class DateTimeModifiedUserElement extends DateTimeUserElement implements DerivedElementInterface
    {
        /**
        ...
        protected function renderControlNonEditable()
        {
            ...
            return $this->renderNonEditableContent('modified');
        }
