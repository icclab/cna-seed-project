<?php
    ...
    /**
     * Render a input to pick a color
     * Class ZurmoColorPicker
     */
    class ZurmoColorPicker extends ZurmoWidget
    {
        public $scriptFile = array('color.js', 'iris.js');

        public $assetFolderName = 'colorPicker';
